<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">WIRE</h2>
        <p class="text-gray-600 leading-relaxed">
          Peminatan Musik Produksi Media berfokus pada pengembangan keterampilan manajerial dan teknis dalam menciptakan, mengelola bisnis, dan memasarkan musik. Mahasiswa di peminatan ini mempelajari berbagai aspek seperti produksi musik, pemasaran musik, industri-bisnis musik, hak cipta dan copyrights dalam dunia musik, dan sebagainya.
        </p>
      </div>
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/wire.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
