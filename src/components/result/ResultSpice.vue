<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">SPICE</h2>
        <p class="text-gray-600 leading-relaxed">
          Peminatan HCI (Human-Computer Interaction) & CT (Computer Technology) Produksi Media berfokus pada pengembangan keterampilan konseptual dan teknis dalam menciptakan software kecerdasan buatan (AI) dan desain antarmuka (interface) komputer.
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/Spice.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
