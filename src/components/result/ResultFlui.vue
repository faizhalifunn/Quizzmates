<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">FLUI</h2>
        <p class="text-gray-600 leading-relaxed">
        Peminatan Fashion & Lifestyle Produksi Media berfokus pada pengembangan keterampilan konseptual dan manajerial dalam mengelola produk dan media fashion/lifestyle. Mahasiswa di peminatan ini mempelajari berbagai aspek seperti desain fashion, manajemen media fashion, talent/model coordination, jurnalisme fashion-lifestyle, dan pemasaran brand/produk fashion & lifestyle </p>
      </div>
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/Flui.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
