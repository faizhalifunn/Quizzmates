<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">OX-LABORATORY</h2>
        <p class="text-gray-600 leading-relaxed">
        Peminatan Game Development di Jurusan Produksi Media Universitas Indonesia berfokus pada pengembangan keterampilan konseptual dan teknis dalam menciptakan permainan digital. Mahasiswa di peminatan ini mempelajari berbagai aspek seperti desain game, pemrograman, pembuatan aset visual dan audio, hingga manajemen proyek game.
 </p>
      </div>
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/Ox.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
