<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">TOBO STUDIO</h2>
        <p class="text-gray-600 leading-relaxed">
          Peminatan Toys & Bricks Produksi Media berfokus pada pengembangan keterampilan konseptual dan teknis dalam menciptakan desain mainan modern. Mahasiswa di peminatan ini mempelajari berbagai aspek seperti desain permainan meja (boardgame), perancangan karakter bricks, pembuatan mainan 3 dimensi, dan sebagainya.
</p>
      </div>
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/Tobo.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
