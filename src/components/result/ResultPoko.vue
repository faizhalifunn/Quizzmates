<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">Pojokomik</h2>
        <p class="text-gray-600 leading-relaxed">
         Peminatan Komik dan Kartun Produksi Media berfokus pada pengembangan keterampilan kreatifitas dan teknis dalam menciptakan karya seni digital, khususnya komik dan/atau kartun. Mahasiswa di peminatan ini mempelajari berbagai aspek seperti desain karakter, perancangan cerita, teknik menggambar tradisional & digital, dan sebagainya.
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/Poko.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
