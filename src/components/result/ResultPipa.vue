<template>
  ...
  >
    ...
    <template v-else>
      ...
      >
        <h2 class="text-2xl font-bold mb-4 text-gray-800">PIXEL PALS</h2>
        <p class="text-gray-600 leading-relaxed">
          Peminatan Animasi dan Desain Visual Produksi Media Universitas Indonesia berfokus pada pengembangan keterampilan kreatif dan teknis dalam menciptakan animasi, gambar bergerak, dan desain komunikasi visual. Mahasiswa di peminatan ini mempelajari berbagai aspek seperti desain visual, pengoperasian software desain, animasi karakter-desain-gambar, dan sebagainya.
      ...
      <div class="w-full max-w-2xl flex flex-col md:flex-row items-stretch gap-6">
        ...
        <div class="bg-white rounded-lg shadow-xl flex items-center justify-center md:w-1/3">
            <img src="@/assets/Pipa.png" alt="Logo Studio WIRE" class="w-full h-full object-cover rounded-md">
        </div>
      </div>
